...
-- AlterTable
ALTER TABLE `option_avantages` ADD COLUMN `valeur` DECIMAL(10, 2) NULL;

-- AlterTable
ALTER TABLE `option_consommations_moyennes` ADD COLUMN `valeur` DECIMAL(10, 2) NULL;

-- AlterTable
ALTER TABLE `option_structures_tarifaires` ADD COLUMN `valeur` DECIMAL(10, 2) NULL;
