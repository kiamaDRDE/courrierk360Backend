...
export class ListCourrierQueryDto extends PaginationQueryDto {
  @ApiPropertyOptional({
    description: 'Recherche globale sur les courriers',
    example: 'Demande',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Date d'enregistrement (YYYY-MM-DD ou ISO)",
    example: '2026-02-12',
  })
  @IsOptional()
  @IsString({ message: 'dateEnregistrement doit être une chaîne de caractères' })
  ...
  @ApiPropertyOptional({
    description: 'Service destinataire du courrier',
    example: 2,
  })
  @IsOptional()
  @Type(() => Number)
