...
export class UpdateTarifInterconnexionDto {
  @ApiPropertyOptional({
  ...
  @ApiProperty({
    description: 'Tarif off-net heure creuse (obligatoire)',
    example: 25.50,
    type: 'number',
  })
  ...
  @ApiProperty({
    description: 'Tarif off-net heure pleine (obligatoire)',
    example: 30.75,
    type: 'number',
  })
  ...
  @ApiProperty({
    description: 'Tarif on-net heure creuse (obligatoire)',
    example: 15.25,
    type: 'number',
  })
  ...
  @ApiProperty({
    description: 'Tarif on-net heure pleine (obligatoire)',
    example: 20.00,
    type: 'number',
  })
