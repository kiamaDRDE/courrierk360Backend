...
export class CreateOffreDto {
  ...
  @ApiProperty({
    ...
    example: 'Forfait Mobile Illimité',
    maxLength: 255,
  })
  @IsNotEmpty({ message: 'Le nom de l\'offre est obligatoire' })
  ...
  @IsNotEmpty({ message: 'La date de début de validité est obligatoire' })
  ...
  @IsNotEmpty({ message: 'Le type d\'offre est obligatoire' })
  ...
  @IsNotEmpty({ message: 'Au moins un service doit être associé à l\'offre' })
  @IsArray({ message: 'Les IDs des services doivent être un tableau' })
  @ArrayNotEmpty({ message: 'Le tableau des services ne peut pas être vide' })
  ...
  @ApiProperty({
    ...
    example: 'Forfait mobile avec appels et internet illimités',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Tarif de péréquation (TP)',
    example: 150.75,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Tarif de numérotation courte (TNC)',
    example: 125.30,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Encaissement postal (EP)',
    example: 85.25,
    required: false,
  })
  @IsOptional()
